...
- **GitHub Security Advisories**: [Report here](https://github.com/Avinashvelu03/devknife/security/advisories/new)
...
- Always pin to a specific version in production: `"devknife": "1.0.2"`
